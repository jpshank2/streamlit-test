...
if 'company' in st.session_state:
    ...
    with review.form('review_form', clear_on_submit=True):
        ...
        st.form_submit_button('Submit', type='primary', on_click=submit_review, args=(st.session_state['review_employee'], st.session_state['review_project'], st.session_state['review_rating'], st.session_state['review_more'], st.session_state['review_less']))
